...
class VenueModel {
  ...
  final List<String> venueOwnerIds;
  final List<String> venueOwnerPhones;
  final String? venueOwnerId;
  final String? venueOwnerPhone;
  final bool isActive;
  ...
  const VenueModel({
    ...
    this.venueOwnerIds = const [],
    this.venueOwnerPhones = const [],
    this.venueOwnerId,
    this.venueOwnerPhone,
    this.isActive = true,
  ...
  factory VenueModel.fromJson(Map<String, dynamic> json) => VenueModel(
    ...
    venueOwnerIds: List<String>.from(json['venueOwnerIds'] as List? ?? []),
    venueOwnerPhones: List<String>.from(
      json['venueOwnerPhones'] as List? ?? [],
    ),
    venueOwnerId: json['venueOwnerId'] as String?,
    venueOwnerPhone: json['venueOwnerPhone'] as String?,
  ...
  Map<String, dynamic> toJson() => {
    ...
    'adminId': adminId,
    'venueOwnerIds': venueOwnerIds,
    'venueOwnerPhones': venueOwnerPhones,
    'venueOwnerId': venueOwnerId,
    'venueOwnerPhone': venueOwnerPhone,
    'isActive': isActive,
